...
#ifndef AODVATK_HELPER_H
#define AODVATK_HELPER_H
 ...
 */
class AodvAtkHelper : public Ipv4RoutingHelper
{
  public:
    AodvAtkHelper();

    /**
     * @returns pointer to clone of this AodvAtkHelper
     *
     * @internal
     * This method is mainly for internal use by the other helpers;
     * clients are expected to free the dynamic memory allocated by this method
     */
    AodvAtkHelper* Copy() const override;
     ...
     *
     * This method controls the attributes of ns3::aodvatkatk::RoutingProtocol
     */
