...
{
    static TypeId tid = TypeId("ns3::aodvatkatk::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodvatkatk::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodvatkatk::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodvatkatk::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
{
    static TypeId tid = TypeId("ns3::aodvatkatk::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
