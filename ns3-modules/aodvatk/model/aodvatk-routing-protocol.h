...
#include "aodvatk-neighbor.h"
#include "aodvatk-packet.h"
#include "aodvatk-rqueue.h"
#include "aodvatk-rtable.h"
...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t AODVATK_PORT;
  ...
  public:
    ...
    /// RNG for the drop decision
    Ptr<UniformRandomVariable> m_dropRv;
